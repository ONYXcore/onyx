...
/* Copyright holder(s) */
#define COPYRIGHT_HOLDERS_FINAL "The ONYX Core developers"

/* Replacement for %s in copyright holders string */
#define COPYRIGHT_HOLDERS_SUBSTITUTION "ONYX Core"
...
#define PACKAGE_BUGREPORT "https://github.com/ONYXcore/onyx/issues"

/* Define to the full name of this package. */
#define PACKAGE_NAME "ONYX Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "ONYX Core 1.0.1"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "ONYX"
