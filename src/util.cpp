...
const char * const BITCOIN_CONF_FILENAME = "onyx.conf";
const char * const BITCOIN_PID_FILENAME = "onyxd.pid";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "onyx";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/onyx";
#else
    // Unix
    return pathRet / ".onyx";
#endif
