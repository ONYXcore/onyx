...
* Update translations (ping wumpus on IRC) see [translation_process.md](https://github.com/ONYXcore/onyx/blob/master/doc/translation_process.md#synchronising-translations).

* Update manpages, see [gen-manpages.sh](https://github.com/ONYXcore/onyx/blob/master/contrib/devtools/README.md#gen-manpagessh).
...
### onyx maintainers/release engineers, suggestion for writing release notes
...
### Build and sign onyx Core for Linux, Windows, and macOS:
...
- Update bitcoin.org version
  ...
  - First, check to see if the onyx.org maintainers have prepared a
  ...
  - If they have not prepared a release, follow the onyx.org release
...
- Announce the release:
  ...
  - onyx Core announcements list https://bitcoincore.org/en/list/announcements/join/

  - bitcoincore.org blog post

  - Update title of #bitcoin on Freenode IRC

  - Optionally twitter, reddit /r/onyx, ... but this will usually sort out itself
