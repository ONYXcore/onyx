...
This document provides guidelines for internationalization of the onyx Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `onyx_en.ts` remains unchanged.
