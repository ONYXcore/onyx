# Support for Output Descriptors in onyx Core

Since onyx Core v2.17.0, there is support for Output Descriptors in the
...
on onyx's OP_CHECKMULTISIG opcode. To support these, we introduce the
...
existing onyx Core wallets, a convenience function `combo` is
