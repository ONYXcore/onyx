...
[Translation Process](https://github.com/onyxio/onyx/blob/master/doc/translation_process.md) 
...
The following applies to code changes to the onyx Core project (and related
projects such as libsecp256k1), and is not to be confused with overall onyx
Network Protocol consensus changes.

Whether a pull request is merged into onyx Core rests with the project merge
...
Patches that change onyx consensus rules are considerably more involved than
...
Where a patch set proposes to change the onyx consensus, it must have been
...
The project leader is the release manager for each onyx Core release.
